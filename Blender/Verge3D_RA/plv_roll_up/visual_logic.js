...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        LIST_NONE, getObjectName, initObjectPicking, isObjectAmongObjects,
...
function process_opened_file() {
  replaceTexture('replace_img_texture', 'import_image.jpg', openedFile('DATA'), function() {});
}
...
eventHTMLElem('click', 'taille-1', true, function(event) {
  changeVis('taille_1', true);
  changeVis(['taille_2', 'taille_3', 'taille_4'], false);
  setObjTransform(['base_1', 'base_2', 'base_3', 'base_4'], false, 'scale', [1, '', ''], false);
  zoomCamera('taille_1', 1, function() {});
  set_state_changed();
});
eventHTMLElem('click', 'taille-2', true, function(event) {
  changeVis('taille_2', true);
  changeVis(['taille_1', 'taille_3', 'taille_4'], false);
  setObjTransform(['base_1', 'base_2', 'base_3', 'base_4'], false, 'scale', [1.44, '', ''], false);
  zoomCamera('taille_2', 1, function() {});
  set_state_changed();
});
eventHTMLElem('click', 'taille-3', true, function(event) {
  changeVis('taille_3', true);
  changeVis(['taille_1', 'taille_2', 'taille_4'], false);
  setObjTransform(['base_1', 'base_2', 'base_3', 'base_4'], false, 'scale', [1.95, '', ''], false);
  zoomCamera('taille_3', 1, function() {});
  set_state_changed();
});
eventHTMLElem('click', 'taille-4', true, function(event) {
  changeVis('taille_4', true);
  changeVis(['taille_1', 'taille_2', 'taille_3'], false);
  setObjTransform(['base_1', 'base_2', 'base_3', 'base_4'], false, 'scale', [3.21, '', ''], false);
  zoomCamera('taille_4', 1, function() {});
  set_state_changed();
});
...
eventHTMLElem('click', 'socle-1', true, function(event) {
  changeVis('base_1', true);
  changeVis(['base_2', 'base_3', 'base_4'], false);
  set_state_changed();
});
eventHTMLElem('click', 'socle-2', true, function(event) {
  changeVis('base_2', true);
  changeVis(['base_1', 'base_3', 'base_4'], false);
  set_state_changed();
});
eventHTMLElem('click', 'socle-3', true, function(event) {
  changeVis('base_3', true);
  changeVis(['base_1', 'base_2', 'base_4'], false);
  set_state_changed();
});
eventHTMLElem('click', 'socle-4', true, function(event) {
  changeVis('base_4', true);
  changeVis(['base_1', 'base_2', 'base_3'], false);
  set_state_changed();
});

registerOnClick(['taille_1', 'taille_2', 'taille_3', 'taille_3'], false, false, [0,1,2], function() {
  openFile(function() {
    process_opened_file();
  });
  set_state_changed();
