...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        getObjectByName, LIST_NONE, getObjectName, initObjectPicking,
        isObjectAmongObjects, retrieveObjectNames, transformCoordsSpace, transformEulerV3dToBlenderShortest,
        getSceneCoordSystem, RotationInterface, getElement, convertObjToJsonDataUrl,
    };
};
...
this.procedures["process_opened_file2"] = process_opened_file2;
this.procedures["get_glbBase64"] = get_glbBase64;
this.procedures["set_state_changed"] = set_state_changed;

var PROC = {
    "process_opened_file2": process_opened_file2,
...
var VARS = Object.defineProperties({}, {
    ...
    'prompt_clone': { get: function() { return prompt_clone; }, set: function(val) { prompt_clone = val; } },
});
...
function process_opened_file2() {
  replaceTexture('tissu', 'import_image.jpg', openedFile('DATA'), function() {});
}
...
registerOnClick('Courbe', false, false, [0,1,2], function() {
  openFile(function() {
    process_opened_file2();
  });
}, function() {});

registerOnClick('Droit', false, false, [0,1,2], function() {
  openFile(function() {
    process_opened_file2();
  });
}, function() {});
...
eventHTMLElem('click', 'very_small', true, function(event) {
  setObjTransform(['Droit', 'Courbe', null, null], false, 'scale', [1, 1, 1], false);
  set_state_changed();
});
eventHTMLElem('click', 'small', true, function(event) {
  setObjTransform(['Droit', 'Courbe', null, null], false, 'scale', [1.2, 1.2, 1.2], false);
  set_state_changed();
});
eventHTMLElem('click', 'medium', true, function(event) {
  setObjTransform(['Droit', 'Courbe', null, null], false, 'scale', [1.4, 1.4, 1.4], false);
  set_state_changed();
});

eventHTMLElem('click', 'forme_1', true, function(event) {
  changeVis('Courbe', true);
  changeVis(['Droit', null, null], false);
  set_state_changed();
});
eventHTMLElem('click', 'forme_2', true, function(event) {
  changeVis('Droit', true);
  changeVis(['Courbe', null, null], false);
  set_state_changed();
});

/* Ajout d’interactivité à l’élément de saisie de la largeur / Objet Droit */
eventHTMLElem('change', 'largeur', true, function(event) {
  setMorphFactor('Droit', 'width', getHTMLElemAttribute('value', 'largeur', true));
});

/* Ajout d’interactivité à l’élément de saisie de la hauteur / / Objet Droit */
eventHTMLElem('change', 'hauteur', true, function(event) {
  setMorphFactor('Droit', 'height', getHTMLElemAttribute('value', 'hauteur', true));
});

/* Ajout d’interactivité à l’élément de saisie de la largeur / Objet Courbe */
eventHTMLElem('change', 'largeur', true, function(event) {
  setMorphFactor('Courbe', 'width', getHTMLElemAttribute('value', 'largeur', true));
});

/* Ajout d’interactivité à l’élément de saisie de la hauteur / / Objet Courbe */
eventHTMLElem('change', 'hauteur', true, function(event) {
  setMorphFactor('Courbe', 'height', getHTMLElemAttribute('value', 'hauteur', true));
});
