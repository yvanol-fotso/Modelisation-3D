...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        getObjectByName, LIST_NONE, convertObjToJsonDataUrl,
    };
};
...
function process_opened_file2() {
  replaceTexture('import_img', 'import_image.jpg', openedFile('DATA'), function() {});
}
...
registerOnClick('tissu', false, false, [0,1,2], function() {
  openFile(function() {
