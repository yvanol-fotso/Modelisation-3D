...
function process_opened_file() {
  replaceTexture('import_img', 'import_image.jpg.002', openedFile('DATA'), function() {});
}
...
registerOnClick(['pouf', null, null, null], false, false, [0,1,2], function() {
  openFile(function() {
    process_opened_file();
  });
  set_state_changed();
